...
export const getNextSBTransactionsURL = (state: RootState, currency: WalletCurrencyType) => {
  return state.dataPath.custodial[currency].nextSBTransactionsURL
}

export const getSBTransactionsPending = (state: RootState, currency: WalletCurrencyType) => {
