...
export class Currency extends Type {
  ...
  convert(pairs, toCurrency) {
    ...
    return sequence(Maybe.of, [toCurrencyM, pairsM]).chain(([toCurrency, pairs]) => {
...
export const convertWithRate = curry((toCurrency, rate, reverse, currencyObject) =>
