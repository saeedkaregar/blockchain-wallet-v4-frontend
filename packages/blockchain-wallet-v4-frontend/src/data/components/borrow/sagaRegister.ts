...
export default ({ api, coreSagas, networks }) => {
  ...
  return function* borrowSaga() {
    ...
    yield takeLatest(AT.AMT_COLLATERAL_REQUIRED_CLICK, borrowSagas.amtCollateralRequiredClick)
    ...
    yield takeLatest(AT.FETCH_LOAN_TRANSACTIONS, borrowSagas.fetchLoanTransactions)
    yield takeLatest(AT.FETCH_USER_BORROW_HISTORY, borrowSagas.fetchUserBorrowHistory)
