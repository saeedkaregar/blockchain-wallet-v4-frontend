...
export const getLoanTransactions = (state: RootState) => state.components.borrow.loanTransactions
...
export const getBorrowHistory = (state: RootState) => state.components.borrow.borrowHistory
