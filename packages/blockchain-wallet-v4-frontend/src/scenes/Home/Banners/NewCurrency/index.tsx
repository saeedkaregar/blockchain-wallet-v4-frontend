...
const NewCurrency = ({ announcementState, cacheActions, coin = 'WDGLD', simpleBuyActions }) => {
  ...
  return (
    <StyledWrapper>
      ...
      <VerbText>
        <FormattedMessage id='copy.trade' defaultMessage='Trade' /> {coinDisplay}{' '}
      ...
      <CTAButton
        ...
        nature='primary'
        onClick={() => simpleBuyActions.showModal('TransactionList', coin as CoinType)}
        small
