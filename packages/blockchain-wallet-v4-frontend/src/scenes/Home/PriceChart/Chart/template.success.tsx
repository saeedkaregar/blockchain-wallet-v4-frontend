...
import { CoinType, FiatType, PriceChangeTimeRangeType } from 'blockchain-wallet-v4/src/types'
...
const Chart = (props: OwnProps) => {
  ...
  const handleCallback = (chart) => renderMinMax(chart, { currency, data, decimals })
