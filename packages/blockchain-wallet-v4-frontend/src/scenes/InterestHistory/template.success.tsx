    ...
    <Container style={{ minWidth: '900px', paddingBottom: '45px' }}>
      ...
      <Table style={{ minWidth: '900px' }}>
        ...
        {txList.map((tx: InterestTransactionType) => {
          ...
          const { coinTicker, colorCode, displayName } = supportedCoins[amount.symbol]
            ...
            <TableRow key={id}>
              <InterestTableCell width='20%'>
                {type === 'WITHDRAWAL' ? (
                  ...
                  <>
                    <IconBackground color={`${colorCode}-light`}>
                      <Icon name='arrow-down' color={colorCode} size='20px' weight={600} />
                    </IconBackground>
                  ...
                  <>
                    ...
                    <Value data-e2e='interestEarnedTx'>{coinTicker} Interest Earned</Value>
                  </>
                )}
              </InterestTableCell>
              <TableCell width='20%'>
