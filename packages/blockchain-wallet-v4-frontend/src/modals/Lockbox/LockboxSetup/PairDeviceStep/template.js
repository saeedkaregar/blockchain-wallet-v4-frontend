    ...
    <Wrapper>
      ...
      <ContactSupportText inline>
        ...
        <SupportText href={supportLink} target='_blank' size='11px' weight={500}>
          <FormattedHTMLMessage id='buttons.contact_support' defaultMessage='Contact Support' />
        </SupportText>
      </ContactSupportText>
    ...
    <Wrapper>
      ...
      <TextGroup inline style={{ marginBottom: '14px' }}>
        ...
        <ClickableText style={{ marginLeft: '-2px' }} size='10px' onClick={onGoToAppManager}>
          <FormattedHTMLMessage id='modals.lockboxsetup.pairdevice.here' defaultMessage='here.' />
        </ClickableText>
      </TextGroup>
